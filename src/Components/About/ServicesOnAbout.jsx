      ...
      <p className='font-custom1 uppercase font-extrabold text-gray-400'>We specialize in</p>
        ...
        <div className='grid grid-rows-4 gap-y-10 mt-8 lg:mt-20'>
          ...
          {services.map((service, index) => (
            ...
            >
              <motion.p ref={ref} initial="hidden" animate={inView ? "visible" : "hidden"} variants={serviceVariants} transition={{ delay: index * 0.4, ease: "easeOut" }} className={`font-custom uppercase font-extrabold text-[22px] lg:text-3xl 2xl:text-4xl ${hoveredService === index ? 'text-[#DF319A]' : ''}`}>
                {service.title}
