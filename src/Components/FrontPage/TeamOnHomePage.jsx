...
//         <div className='w-[100%] h-[90vh] flex gap-x-5'>
//           {teamMembers?.map((team) => (
//             <>
//               <div className='flex-1 hover:flex-[2] hover:transition-all hover:duration-1000 hover:ease-linear'>
//                 <img className='h-full object-cover' src={team?.image} alt='' />
//               </div>
//             </>
//           ))}
//           </div>
...
//       <div className="flex overflow-hidden px-3">
//         {data?.data?.slice(currentSlide, currentSlide + slidesPerPage).map((member, index) => (
//           <motion.div
//             key={member.id}
//             className={`w-full ${isMobile ? 'md:w-full lg:w-full' : 'md:w-1/2 lg:w-1/3'} flex-1 hover:flex-[2] hover:transition-all hover:duration-700 hover:ease-linear mt-[29px] px-1 justify-center text-[#979797] text-[18px]`}
//           >
//             <div className="rounded-lg ">
//               <motion.img
//                 src={`${apiUrl}${member?.attributes?.image?.data[0]?.attributes?.url}`}
//                 alt={member.name}
//                 className={`w-full h-[50vh] md:h-[90vh] object-cover cursor-pointer ${
//                   index === 0 ? 'active-slide' : ''
//                 }`}
...
//                 onMouseLeave={handleMouseLeave}
//               />
//               <h2 className="font-custom1 font-bold mt-2">{member?.attributes?.fullName}</h2>
//               <p className='font-custom1'>{member?.attributes?.role}</p>
//             </div>
//           </motion.div>
//         ))}
//       </div>
