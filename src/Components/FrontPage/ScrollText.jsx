...
const ScrollText = () => {
    ...
    const x = useTransform(scrollYProgress, [1, 0], [-155, 750]);

  return (
    <>
    <div className='bg-black lg:py-[152px] lg:px-[30px] overflow-hidden textTransition justify-center items-center mx-auto text-center'>
