...
const Quote = () => {
  ...
  return (
    <motion.div
      className="bg-black h-[481px] p-4 text-white md:px-8 lg:px-[176px] flex flex-col justify-center items-center mt-20 lg:mx-[65px] text-center"
    ...
    >
      ...
      <div className='mt-4 md:mt-6 lg:mt-8'>
        <p className='text-base md:text-lg lg:text-xl font-custom1'>{currentQuote.author}</p>
        <p className='text-base md:text-lg lg:text-xl font-custom1'>{currentQuote.role}</p>
      </div>
    </motion.div>
  );
};
