...
const Newest = () => {
  ...
  return (
    <div className="py-0 md:py-8 " ref={ref}>
      <motion.div
        initial="hidden"
        animate={inView ? 'visible' : 'hidden'}
        variants={slideInVariants}
      >
        <div className="grid px-3 lg:px-6 grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-x-6 gap-y-12">
            ...
            >
              ...
              <div className="relative w-full h-full">
                ...
                <div className='w-full mt-[10px]'>
                  <p className='font-custom text-black text-[22px]'>{item.workName}</p>
                  {hoveredIndex === index && (
